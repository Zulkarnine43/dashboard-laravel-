        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header row">
                    <div class="col-6">
                        @if(isset($campaign[0]))
                            <h3 class="card-title pull-left" for="category-title">{{$campaign[0]->campaign_name}}--Campaign Product List</h3>
                        @else
                    ...
                    <div class="col-6">
                        <div class="float-right">
                            @isset($campaign[0])
                                <a href="{{ url('products-for-campaign/'.$campaign[0]->campaign_id) }}">
                                    <button type="button"
                                        class="btn btn-block btn-outline-success btn-sm">Add Product
                                    </button>
                                </a>
                            @endisset
