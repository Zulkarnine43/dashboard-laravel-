        ...
        <div class="container-fluid">
            <div class="card card-primary col-md-12">
                <div class="card-header row">
                    <div class="col-12">
                        @if(isset($campaign[0]))
                            <h3 class="card-title pull-left" for="category-title">Prodcuts For #{{$campaign[0]->campaign_name}} Campaign
                            </h3>
                        @endif
                                               ...
                                               @endphp
                                                <tr class="odd">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-outline-success" href="{{ url('campaign-product-form/'.$campaign_id.'/'.$item->xitemid) }}"> Add </a>
                                                    </td>
                                                </tr>
                                            @endforeach
